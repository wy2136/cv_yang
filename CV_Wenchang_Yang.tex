...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textcolor{headerColor}{\sffamily Curriculum Vitae: Wenchang Yang, Ph.D.}}
\rfoot{\textcolor{footerColor}{\sffamily Page \thepage{} of \pageref{LastPage}}}
...
\newcommand{\titleMinipage}[1]
{
	\ifthenelse{\equal{#1}{withoutPhoto}}{
		...
		\contact{
			...
			2101E Croul Hall, Irvine, CA 92697, US \\ 
			yang.wenchang@uci.edu \\
			+1 (646)801-8086 \\
			\url{http://www.ess.uci.edu/~wenchay}\\
		}
%                 \contact{
%			Lamont-Doherty Earth Observatory \\
%			\cu{}\\
%			61 Route 9W, Oceanography 105F,  Palisades, NY 10964, US \\ 
%			wyang@ldeo.columbia.edu \\
%			\url{http://www.ldeo.columbia.edu/~wyang}\\
%		}
	}{}
	
	\ifthenelse{\equal{#1}{withPhoto}}{
		\name{\flushleft Wenchang Yang}
		\contact{\flushleft
			Postdoctoral Scholar \\
			Department of Earth System Science \\
			University of California, Irvine \\
...
%			\url{http://www.ldeo.columbia.edu/~wyang}\\
%		}
		\vspace{-0.28\textwidth}\hfill
		\includegraphics[width=0.28\textwidth]{YangTieSquare.jpg}
		\vspace{-0.0\textwidth}
	}{}
}
...
\begin{itemize}[leftmargin=4ex]
	\item Climate Variability, Extreme Weather and Climate
	\item Arctic Climate, Regional Hydroclimate, Precipitation and Drought
...
%\begin{etaremune}[itemsep=0.3em,parsep=0pt, leftmargin=10ex]
...
%\section{Expertise}
%\subsection{Atmospheric Sciences, Climatology and Physical Oceanography}
%	\indentitem{Tropical Climate, Monsoon Dynamics, Middle-latitude Baroclinic Waves, Storm Track Dynamics, Atmospheric Dynamics, Geophysical Fluid Dynamics, Climate Dynamics, Ocean Dynamic}
%\subsection{Mathematics}
%	\indentitem{Numerical Analysis, Probability Theory and Statistics, Calculus, Linear Algebra, Ordinary Differential Equations, Partial Differential Equations, Methods of Mathematical Physics}
%\subsection{Physics}
%	\indentitem{Fluid Dynamics, Thermodynamics and Statistics, Mechanics, Thermology, Theoretical Mechanics}


%\section{Computer Skills}
%\subsection{Operating Systems}
%	\indentitem{OS X, Linux, Microsoft Windows family}
%\subsection{Programming Languages}
%	\indentitem{Python, Matlab, Shell Script, Fortran, C, Ingrid, HTML, Javascript, PHP}
%\subsection{Typesetting and Productivity Software}
%	\indentitem{\LaTeX{}, Bib\TeX{}, Apple iWork, Microsoft Office}
