...
\pagestyle{fancy}
\fancyhf{}
\lhead{\textcolor{headerColor}{\sffamily 简历：杨文昌, PhD}}
\rfoot{\textcolor{footerColor}{\sffamily 第\thepage{}页，共\pageref{LastPage}页}}
...
\newcommand{\titleMinipage}[1]
{
	\ifthenelse{\equal{#1}{withoutPhoto}}{
		...
		\contact{
			博士后学者 \\
			加州大学尔湾分校 地球系统系 \\
			地址： 2101E Croul Hall, Irvine, CA 92697, US \\ 
	...
	\ifthenelse{\equal{#1}{withPhoto}}{
		...
		\includegraphics[width=0.25\textwidth]{YangTieSquare.jpg}
		\vspace{-.0\textwidth}
	}{}
}
...
\begin{itemize}[leftmargin=4ex,label={}, noitemsep, nolistsep]
	\item 北极气候及变化, 水汽输送,
	 干旱与降水, 东非气候,
	 ITCZ, 全球季风, 风暴路径, 理想大气模式
\end{itemize}


\section{教育背景}
\begin{itemize}[leftmargin=10ex,label={}, noitemsep, nolistsep]
	\item[2014] 哥伦比亚大学地球与环境科学系哲学博士
	\begin{itemize}[leftmargin=0ex,label={},noitemsep,nolistsep]
		博士论文: \phdThesis{}.  
		导师: \richard{} 教授,  \cane{} 教授
		\end{itemize}
	\item[2011] 哥伦比亚大学地球与环境科学系哲学硕士
	\item[2007] 北京大学物理学院大气科学系理学硕士。导师: \benkui{}教授
	\item[2004] 北京大学物理学院大气科学系理学学士
	\end{itemize}
